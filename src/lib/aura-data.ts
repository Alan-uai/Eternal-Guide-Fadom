...
export const allAuras: Aura[] = [
    ...
    { id: 'fire-king-aura', name: 'Fire King Aura', world: 'World 4', bonus_type: 'luck', bonus_value: '25%' },
    ...
    { id: 'virtual-aura', name: 'Virtual Aura', world: 'World 15', bonus_type: 'luck', bonus_value: '35%' },
